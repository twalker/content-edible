(function (factory) {
  ...
  ["bold", "italic", "copy", "cut", "paste", "delete", "forwardDelete", "fontName", "fontSize", "foreColor", "hiliteColor", "backColor", "justifyCenter", "justifyFull", "justifyLeft", "justifyRight", "strikeThrough", "subscript", "superscript", "underline", "removeFormat", "heading", "formatBlock", "indent", "outdent", "createLink", "unlink", "insertBrOnReturn", "insertHorizontalRule", "insertImage", "insertOrderedList", "insertUnorderedList", "insertParagraph", "insertText", "insertHTML", "undo", "redo", "selectAll"].forEach(function (command) {
